...
function SingleAchievement(props)
{
  ...
  <img src={props.photo} alt="" style={{width: '100%', height: '15vw', objectFit: 'cover'}} />
...
{
  return(  <div className="container" id="achievements">
  <h1 className="achievement mt-5 text-primary">
    <hr />
    Achievements
  </h1>
  <div className="row mt-5">
  <SingleAchievement name='INDIA AT 70' photo="a1.jpg" alt="" style={{width: '100%', height: '15vw', objectFit: 'cover'}} detail="India's key achievement under successive congress governments."/>
  <SingleAchievement name='CREATING REPUBLIC' photo="a2.jpg" alt="" style={{width: '100%', height: '15vw', objectFit: 'cover'}} detail="  the indian freedom movement was perhaps the greatest mass
                movement in world history."/>
  <SingleAchievement name='BUILDING AN EQUAL INDIA' photo="a3.jpg" alt="" style={{width: '100%', height: '15vw', objectFit: 'cover'}} detail="  at the heart of our democracy is the right of the universal
                adult suffrage."/>
  <SingleAchievement name='BRINGING PROSPERITY' photo="a4.jpg" alt="" style={{width: '100%', height: '15vw', objectFit: 'cover'}} detail="'When we undertaken a big work we have to do so with a large
                heart and a large mind.'-Pt.Jawaharlal Nehru,Bhakra Nangal,July
                8,1954"/>
  <SingleAchievement name='STRENGTHENING NATION' photo="a5.jpg" alt="" style={{width: '100%', height: '15vw', objectFit: 'cover'}} detail=" 'secularism and democracy are the twin pillars of our state the
                very foundation of our society.'-Smt.Indira
                Gandhi,Parliament,December 22,1967"/>
  <SingleAchievement name='PROMOTING PEACE' photo="a6.jpg" alt="" style={{width: '100%', height: '15vw', objectFit: 'cover'}} detail=" 'We have to build in our own countries societies where freedom
